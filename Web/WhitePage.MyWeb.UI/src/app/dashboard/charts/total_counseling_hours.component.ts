...
export class TotalCounselingHoursComponent extends ChartsController {
    ...
    constructor(caseService: CasesService, commonService: CommonService, chartsService: ChartsService) {
        ...
        this.getCenterChartsData("TotalHoursSpentLookupId", "HoursCenterWise");
        this.getCounselorChartsData("TotalHoursSpentLookupId", "HoursCounselorWise");
        this.getPeacemakerChartsData("TotalHoursSpentLookupId", "HoursPeacemakerWise");
